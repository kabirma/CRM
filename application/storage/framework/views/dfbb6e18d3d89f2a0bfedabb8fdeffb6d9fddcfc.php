                ...
                <thead>
                    <tr>
                        ...
                        <th class="col_doc_status"><a class="js-ajax-ux-request js-list-sorting" id="sort_doc_status"
                                href="javascript:void(0)"
                                data-url="<?php echo e(urlResource('/foos?action=sort&orderby=doc_status&sortorder=asc')); ?>"><?php echo app('translator')->get('lang.status'); ?><span
                                    class="sorting-icons"><i class="ti-arrows-vertical"></i></span></a></th>
...
</div><?php /**PATH /home/bu3bnaylnadr/public_html/crm/application/resources/views/pages/proposals/components/table/table.blade.php ENDPATH**/ ?>